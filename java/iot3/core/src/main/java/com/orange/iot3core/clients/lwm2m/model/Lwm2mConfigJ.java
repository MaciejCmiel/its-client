...
public abstract class Lwm2mConfigJ implements Serializable {
    ...
    /**
     * Java version of {@link Lwm2mConfig.Lwm2mBootstrapConfig} please consider using Kotlin (just for simple POJO classes) ;)
     ...
     *
     */
    public static class Lwm2mBootstrapConfig extends Lwm2mConfigJ {
     ...
     *
     */
    public static class Lwm2mClassicConfig extends Lwm2mConfigJ {
        private final String endpointName;
        private final String uri;
        private final String pskIdentity;
        private final String privateKey;
